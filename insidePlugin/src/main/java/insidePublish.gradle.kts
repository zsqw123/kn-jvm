...
val publishProperties = File(gradle.gradleUserHomeDir, "publish.properties")

val canPublish = publishProperties.exists()

if (canPublish) {
    println("need publish...")
    publishProperties
    ...
    val projectGitUrl = "https://github.com/zsqw123/kn-jvm"
    ...
    System.err.println("No publish.properties found, will skip configuring publishing")
}
